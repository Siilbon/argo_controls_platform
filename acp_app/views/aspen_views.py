...
def aspen_search(search_term):
    ...
    try:
        ...
        aspen_io_table = render_dataframe(aspen_conn.iogethistdef(search_term), bootstrap_table=True)

        aspen_ip_table = render_dataframe(aspen_conn.ip_analog(search_term), bootstrap_table=True)
